...
public record MotifSearchRequest(
        ...
        @NotBlank(message = Constants.MOTIF_CANNOT_BE_BLANK_ERROR_MESSAGE)
        @Pattern(regexp = Constants.SEQUENCE_REGEX, message = Constants.MOTIF_REGEX_ERROR_MESSAGE)
        String motif
) {
}